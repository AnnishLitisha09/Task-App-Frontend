...
class _VenueDetailsPageState extends State<VenueDetailsPage> {
              ...
              Row(
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: onReject,
                      child: _miniActionBtn("Reject", Colors.grey),
                    ),
                  ),
                  const SizedBox(width: 8),
                  Expanded(
                    child: InkWell(
                      onTap: onApprove,
                      child: _miniActionBtn("Approve", brandAccent),
                    ),
                  ),
                ],
              ),
  ...
  Future<void> _handleQuickApprove(int taskId) async {
    setState(() => _isLoading = true);
    try {
  ...
  Future<void> _handleQuickReject(int taskId) async {
    setState(() => _isLoading = true);
    try {
